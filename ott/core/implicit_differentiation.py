...
class ImplicitDiff:
  ...
  def solve(
    ...
    if self.symmetric:
      ...
      solver_fun = jax.scipy.sparse.linalg.cg if self.solver_fun is None else self.solver_fun
    else:
      ...
      solver_fun = jax.scipy.sparse.linalg.gmres if self.solver_fun is None else self.solver_fun
