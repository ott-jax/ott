...
class DualPotentials:
    ...
    def __init__(self, f: Potential_t, g: Potential_t, *, cost_fn: costs.CostFn, corr: bool = False):
        self._f = f
        self._g = g
        assert (
    ...
    @classmethod
    def tree_unflatten(cls, aux_data: Dict[str, Any], children: Sequence[Any]) -> "DualPotentials":  # noqa: D102
    ...
    def plot_ot_map(
        ...
        if legend_kwargs is None:
            legend_kwargs = {"ncol": 3, "loc": "upper center", "bbox_to_anchor": (0.5, -0.05), "edgecolor": "k"}
    ...
    def plot_potential(
        ...
        Args:
          ...
          displacement: whether to plot the Kantorovich potential
          ax: axis to add the plot to
