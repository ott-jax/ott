...
conditional_perturbation_network.ConditionalPerturbationNetwork` or any
    ...
    def __init__(
        ...
        fitting_loss: Optional[
            Callable[
                [jnp.ndarray, jnp.ndarray], Tuple[float, Optional[Any]]
            ]
        ] = None,
    ...
    def regularizer(
        ...
        [jnp.ndarray, jnp.ndarray, jnp.ndarray], Tuple[float, Optional[Any]]
    ]:
    ...
    def _get_step_fn(self) -> Callable:
        ...
        def loss_fn(
            ...
            val_tot_loss = (
                val_fitting_loss
                + self.regularizer_strength[step] * val_regularizer
            )
