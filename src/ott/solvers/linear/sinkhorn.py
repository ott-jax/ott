...
class SinkhornOutput(NamedTuple):
  ...
  Attributes:
    f: potential
    g: potential
    errors: the list of errors of the Sinkhorn iterations
    reg_ot_cost: the final cost value in the primal space
    ot_prob: the problem Sinkhorn was fit on
    dual_cost: the final unregularized cost value in the dual space
    ...
    scalings: tuple of the scaling vectors
    matrix: the transport plan matrix
