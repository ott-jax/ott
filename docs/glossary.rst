...
.. glossary::
    ...
    entropy-regularized optimal transport
        ...
        solves the unbalanced optimal transport problem with a variable
    ...
    coupling
        ...
        such that its first and second marginals coincide with :math:`\mu` and
        :math:`\nu` respectively. Equivalently, given two non-negative vectors
        :math:`a\in\mathbb{R}^n` and :math:`b\in\mathbb{R}^m` that sum to the
        same quantity, a coupling in matrix form is a non-negative matrix
        :math:`P` such that :math:`P\mathbf{1}_m=a, P^T\mathbf{1}_n=b`.
    ...
    transport map
        ...
        that is in the support of a target distribution :math:`\nu`, which must
