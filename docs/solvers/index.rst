...
:mod:`ott.solvers.was_solver` module, which provides a lower-level template
at the interface between the two. Neural based solvers in :mod:`ott.solvers.nn`
live on a different category of their own, since they typically solve the Monge
formulation of OT.
